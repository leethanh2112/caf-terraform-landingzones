module "solution" {
  ...
  source = "git::ssh://git@ssh.dev.azure.com:v3/petronasvsts/azure-terraform-sandpit-caf-configuration/terraform-azurerm-caf?ref=feature/feature/backup_policy_vm_workload"
  providers = {
